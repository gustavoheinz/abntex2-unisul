...
\subcaption*{Fonte: http://unisul.br/}
\end{figure}
...
\end{tabular}
\subcaption*{Fonte: FUNDAÇÃO INSTITUTO BRASILEIRO DE GEOGRAFIA E ESTATÍSTICA. \textbf{Normas de apresentação tabular}. 3.ed. Rio de Janeiro, 1993. p. 51}
\end{table}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \subcaption*{Fonte: Autor do Trabalho}
\end{figure}
